...
cwal_midsize_t
whcl__strftime(char *s, cwal_midsize_t maxsize,
              const char *format, const struct tm *timeptr)
{
    ...
    again:
        ...
        case 'D':    /* date as %m/%d/%y */
            whcl__strftime(tbuf, sizeof tbuf, "%m/%d/%y", timeptr);
            break;
        ...
        case 'r':    /* time as %I:%M:%S %p */
            whcl__strftime(tbuf, sizeof tbuf, "%I:%M:%S %p", timeptr);
            break;

        case 'R':    /* time as %H:%M */
            whcl__strftime(tbuf, sizeof tbuf, "%H:%M", timeptr);
            break;

        case 'T':    /* time as %H:%M:%S */
            whcl__strftime(tbuf, sizeof tbuf, "%H:%M:%S", timeptr);
            break;
#endif
